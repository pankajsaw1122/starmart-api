...
const productSchema = Joi.object().keys({
    ...
    weight: Joi.number().required().integer(),
    dimensionLength: Joi.number().integer(),
    dimensionWidth: Joi.number().integer(),
    dimensionHeight: Joi.number().integer(),
    shippingClassId: Joi.number().integer(),
    upsells: Joi.string().allow(''),
    crossSells: Joi.string().allow(''),
